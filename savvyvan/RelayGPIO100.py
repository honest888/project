...
GPIOPort=1 #Buzzer GPIO Port
GPIOPortworkaround=100 #workaround to fix savvyvan service updating the incorrect tile
#---------------------------------------------
...
GPIOPortSTR = str(GPIOPortworkaround) #save data to string for Flag concastination
